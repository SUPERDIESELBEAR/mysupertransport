-- Update the notify_operator_on_status_change function to also fire
-- email notifications via pg_net for key onboarding milestones.
-- URL and anon key are hardcoded since ALTER DATABASE is not permitted.
