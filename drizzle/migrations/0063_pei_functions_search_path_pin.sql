-- 0063: the 2026-09-24 draft merge (0060) pinned its four PEI definer functions to
-- search_path 'public' alone; the convention is 'public, extensions'. Bodies are
-- identical to 0060 — only the pin changes. get_pei_queue's missing company filter
-- is NOT fixed here (wish list, "Before any second carrier shares the database").
...
REVOKE EXECUTE ON FUNCTION public.get_pei_queue() FROM PUBLIC, anon;