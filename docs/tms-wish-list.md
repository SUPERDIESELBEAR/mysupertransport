...
- Restrictive-policy ROLLOUT: BATCH 3 (25 driver-facing ownership tables) done 2026-09-17 — **74 tables done, 73 company-bearing tables still pending**, plus `company_members` permanently exempt. Batch order and the fuel caveat (derive from `fuel_import_batches`, never from the operator) are in the pre-check. (record 2026-09-17 — "cleanup after the suite census, and restrictive batch 2"; `docs/passes/2026-09-16-1920-restrictive-policy-precheck.md`)
