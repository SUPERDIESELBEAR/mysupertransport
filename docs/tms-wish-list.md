...
- Next tenancy batch: the 2026-09-16 disposition's twelve MONEY tables (`invoices`, `invoice_line_items`, `invoice_batches`, `invoice_number_config`, `payments`, `factoring_remittances`, `ar_aging_snapshots`, `accessorial_adjustments`, `settlement_settings`, `carrier_signature_settings`, `share_tokens`, `unit_number_config`) — all twelve already CARRY `company_id`; what is missing is the restrictive read enforcement. Not to be confused with the twelve UNSTAMPED fuel/operator/staff tables closed 2026-09-17. (record 2026-09-16 — "the owner's disposition decision, and the live read-enforcement census", sections (a) and (d))
