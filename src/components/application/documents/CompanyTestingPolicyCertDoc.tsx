...
export default function CompanyTestingPolicyCertDoc({ app, signatureDataUrl }: Props) {
  ...
  if (!identity) return <CarrierIdentityUnavailable docLabel={"Certificate of Receipt: Company Testing Policy"} />;
  ...
  return (
    ...
    >
      <CompanyLetterhead
        ...
        subtitle="Federal Motor Carrier Safety Compliance Notice · 49 CFR § 382.601"
      />
      ...
      <CompanyDocFooter identity={identity} docLabel={"Certificate of Receipt: Company Testing Policy \u00b7 49 CFR \u00a7 382.601"} />
    </div>
  );
}
