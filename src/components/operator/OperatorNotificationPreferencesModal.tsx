...
const OPERATOR_EVENT_TYPES: EventTypeDef[] = [
  ...
  },
  {
    ...
    description: 'Urgent reminder when your CDL or Medical Certificate is expiring within 30 days',
    icon: ShieldAlert,
    iconBg: 'bg-red-100',
  ...
  },
  {
    ...
    description: 'Early heads-up email at the 60-day mark so you have plenty of time to renew',
    icon: ShieldAlert,
...
export default function OperatorNotificationPreferencesModal({ open, onClose }: Props) {
  ...
  const fetchPrefs = async () => {
    ...
    OPERATOR_EVENT_TYPES.forEach(e => {
  ...
  const handleDesktopToggle = async (value: boolean) => {
    ...
    // Request permission quietly in the background if it's still unresolved.
