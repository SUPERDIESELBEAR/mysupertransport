...
>(({ className, children, ...props }, ref) => {
  const context = (DialogPrimitive as any).__internal_context;
  // Access open state from the parent Dialog via onOpenChange trick
  const [isOpen, setIsOpen] = React.useState(false);

  // Track open state via data-state attribute changes
