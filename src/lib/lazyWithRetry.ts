...
/**
 * Loads any dynamically imported module with the same stale-chunk recovery used
 * by React.lazy entry points. This also protects the initial App import, which
 * happens before an error boundary exists.
 */
