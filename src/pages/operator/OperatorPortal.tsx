  ...
  const getStageStatus = (stageNum: number): StageStatus => {
    ...
    switch (stageNum) {
      ...
      case 4:
        ...
        return 'not_started';
      case 5:
        if (s.decal_applied === 'yes' && (s.eld_exempt === true || s.eld_installed === 'yes') && s.fuel_card_issued === 'yes') return 'complete';
        ...
        if (s.decal_applied === 'yes' || s.eld_installed === 'yes' || s.eld_exempt === true) return 'in_progress';
        return 'not_started';
      case 6:
  ...
  const stages: Stage[] = [
    ...
    },
    {
      ...
      substeps: [
        ...
        ...(!onboardingStatus.eld_exempt && onboardingStatus.eld_serial_number ? [{ label: 'ELD Serial #', value: onboardingStatus.eld_serial_number as string, status: 'complete' as StageStatus }] : []),
        ...(!onboardingStatus.eld_exempt && onboardingStatus.dash_cam_number ? [{ label: 'Dash Cam #', value: onboardingStatus.dash_cam_number as string, status: 'complete' as StageStatus }] : []),
