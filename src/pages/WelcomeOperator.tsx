...
export default function WelcomeOperator() {
  ...
  useEffect(() => {
    // Listen for the auth event that Supabase fires when the magic / recovery
    // link is clicked. Approved operators arrive here via a PASSWORD_RECOVERY
    // link (generated by `launch-superdrive-invite`). Legacy auth invites
    // fired SIGNED_IN — keep that branch for back-compat with already-sent links.
