...
export default function ManagementPortal() {
  ...
  const navGroups = [
    ...
    // Accounting holds the money modules. Fuel import is the first of them;
    // Settlements (Module 4) and Billing (Module 7) join it later.
    {
      label: 'Accounting',
      items: [
        { label: 'Fuel Import', icon: <Fuel className="h-4 w-4" />, path: 'fuel-import' },
  ...
  return (
    <>
      ...
      >
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-6 gap-2 sm:gap-4">
              ...
              {(() => {
                ...
                const stageBadges = [
                  ...
                  { label: 'OS',  count: sb.stage5_equipment,  dotClass: 'bg-purple-400',         stageKey: 'Stage 5 — Onboard Systems',    title: 'Onboard Systems' },
        ...
        {view === 'fuel-import' && <FuelImportPage />}
        {view === 'fuel-driver-detail' && <FuelDriverDetailPage />}
        {view === 'fuel-location-report' && <FuelLocationReportPage />}
        ...
        {view === 'rate-con-inbox' && (
          <RateConInboxPage onOpenCreateLoad={() => setView('load-create')} />
        )}
