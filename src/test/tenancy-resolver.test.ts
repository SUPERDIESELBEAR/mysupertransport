...
const PENDING_RESTRICTIVE = [
  ...
  'invoices', 'lease_terminations', 'load_charges', 'load_documents',
  'load_reference_citations', 'load_references', 'load_status_history',
  'load_stops', 'loads', 'message_notification_throttle',
  'message_reactions', 'message_threads', 'messages',
  'notification_preferences', 'notifications', 'officer_packet_links',
